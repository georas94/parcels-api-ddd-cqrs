...
class getDoctrine_Fixtures_LoaderService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addFixtures([0 => ['fixture' => ($container->privates['App\\DataFixtures\\ParcelsFixtures'] ?? ($container->privates['App\\DataFixtures\\ParcelsFixtures'] = new \App\DataFixtures\ParcelsFixtures())), 'groups' => []], 1 => ['fixture' => ($container->privates['App\\DataFixtures\\UsersFixtures'] ?? $container->load('getUsersFixturesService')), 'groups' => []]]);
