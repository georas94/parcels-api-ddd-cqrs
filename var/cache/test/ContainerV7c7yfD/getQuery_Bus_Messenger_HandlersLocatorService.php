...
class getQuery_Bus_Messenger_HandlersLocatorService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['query.bus.messenger.handlers_locator'] = new \Symfony\Component\Messenger\Handler\HandlersLocator(['App\\Core\\Application\\Query\\Parcel\\GetParcel\\GetParcelQuery' => new RewindableGenerator(function () use ($container) {
