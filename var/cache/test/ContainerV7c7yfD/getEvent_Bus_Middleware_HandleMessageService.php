 ...
 */
class getEvent_Bus_Middleware_HandleMessageService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['event.bus.middleware.handle_message'] = $instance = new \Symfony\Component\Messenger\Middleware\HandleMessageMiddleware(($container->privates['event.bus.messenger.handlers_locator'] ?? ($container->privates['event.bus.messenger.handlers_locator'] = new \Symfony\Component\Messenger\Handler\HandlersLocator([]))), true);
